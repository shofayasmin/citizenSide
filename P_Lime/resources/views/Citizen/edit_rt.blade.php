                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title">Edit RT</h5>
                                    <p> </p>


                                    <form action="{{ route('rt.update',['id'=> $data->rt_id]) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama RT</label>
                                            <input type="form" name="nama_ketua" value="{{ $data->nama_ketua }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Nama RT">
                                            @error( 'nama_ketua' )
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="form" name="no_rt" value="{{ $data->no_rt }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan No RT (conth: 003)">
                                            @error( 'no_rt' )
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>               
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" name="mulai_masa_jabatan" value="{{ $data->mulai_masa_jabatan }}" class="form-control" id="exampleInputPassword1">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="date" name="berakhir_masa_jabatan" value="{{ $data->berakhir_masa_jabatan }}" class="form-control" id="exampleInputPassword1">
                                            </div>
                                        </div>
