                    ...
                    <div class="hero-inner">
						<div class="hero-copy">
							...
							<div class="hero-form field field-grouped">
								...
								<div class="control">
									<a class="button button-primary button-block" href="{{ route('login') }}">Login</a>
								</div>
							</div>
						</div>
						...
						<div class="features-wrap">
							...
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Kecepatan Loading Halaman</h4>
                                    <p class="text-sm">Website ini dioptimalkan untuk kecepatan, dengan waktu loading halaman yang sangat cepat.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8"> Responsif di Semua Perangkat</h4>
                                    <p class="text-sm">Website ini dirancang untuk responsif, yang berarti tampilannya akan tetap optimal di berbagai perangkat, termasuk desktop, tablet, dan smartphone.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile mb-8">Fitur Keamanan yang Kuat</h4>
                                    <p class="text-sm">Website ini dilengkapi dengan fitur keamanan yang kuat, termasuk enkripsi SSL, autentikasi dua faktor, dan proteksi dari serangan siber. </p>
                                </div>
                            </div>
						</div>
                    </div>
						...
						<div class="testimonials-wrap">
								...
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="{{ asset('april/dist/images/testimonial-01.png') }}" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">"Aplikasi ini luar biasa! Antarmukanya sangat intuitif dan mudah digunakan. Semua fitur yang saya butuhkan tersedia, dan performanya sangat cepat. Saya sangat merekomendasikan aplikasi ini kepada siapa saja yang mencari solusi efektif dan efisien."</p>
										</div>
									</div>
							...
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="{{ asset('april/dist/images/testimonial-02.png') }}" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">"Saya sangat terkesan dengan aplikasi ini! Desainnya elegan dan modern, serta navigasinya sangat lancar. Fitur-fitur yang disediakan sangat membantu dalam menyelesaikan tugas sehari-hari saya. Dukungan pelanggan juga sangat responsif dan membantu. Terima kasih telah menciptakan aplikasi yang hebat ini!"</p>
										</div>
									</div>
									<div class="testimonial-footer">
										<div class="testimonial-link">
							...
							<div class="testimonial text-xs is-revealing">
								<div class="testimonial-inner">
									<div class="testimonial-main">
										<div class="testimonial-header">
											<img class="mb-16" src="{{ asset('april/dist/images/testimonial-03.png') }}" alt="Testimonial">
										</div>
										<div class="testimonial-body">
											<p class="mb-0">"Aplikasi ini telah mengubah cara saya bekerja! Semuanya sangat terorganisir dan mudah diakses. Integrasi dengan alat-alat lain sangat mulus, dan saya dapat menyelesaikan pekerjaan dengan lebih efisien. Saya benar-benar menghargai perhatian terhadap detail dalam setiap aspek aplikasi ini. Pekerjaan luar biasa!"</p>
										</div>
									</div>
									<div class="testimonial-footer">
										<div class="testimonial-link">
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            <h2 class="section-title mt-0">Hi Ternyata kamu sudah Scroll sampai bawah ya</h2>
                            <p class="section-paragraph">Ini adalah ending dari landing page web kami</p>
                        </div>
                    </div>
                </div>
            </section>
